...
export default {
  ...
  data() {
    return {
      ...
      userInfo: {
        user_id: mapState({ user_id: state => state.user_id}),
        ...
        certification_information: this.$store.state.certification_information,
        set_subscription: this.$store.state.set_subscription,
        set_WeChat: this.$store.state.set_WeChat,
      },
      // 给Popup组件传值
      PopupProps: {
        open: false,
